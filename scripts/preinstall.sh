...
if [ "$(uname)" = "Darwin" ]; then
    ...
    (
        ...
        sudo apk add --virtual builders git g++ make cmake unzip libtool curl-dev automake && \
        sudo apk add --repository=https://dl-cdn.alpinelinux.org/alpine/v3.16/main/ libexecinfo-dev && \
